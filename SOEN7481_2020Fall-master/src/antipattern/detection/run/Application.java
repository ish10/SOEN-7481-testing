...
public class Application implements IApplication {
	...
	private void analyze(IPackageFragment mypackage) throws JavaModelException {
		for (ICompilationUnit unit : mypackage.getCompilationUnits()) {
			...
			HashCodeNotEqual  exVisitor = new HashCodeNotEqual(mypackage, unit, parsedUnit);
			InadequateLoggingInformation exVisitor1= new InadequateLoggingInformation(mypackage, unit, parsedUnit);
			UselessControlFlow exVisitor2 =  new UselessControlFlow(mypackage, unit, parsedUnit);
			

			parsedUnit.accept(exVisitor1);
			parsedUnit.accept(exVisitor2);
